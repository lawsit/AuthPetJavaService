...
//Validate the incoming request - 	verify if the token is valid.  
public class JwtAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    public JwtAuthorizationTokenFilter(UserDetailsService userDetailsService, JwtTokenUtil jwtTokenUtil, String tokenHeader) {
    	logger.info("Token header is " + tokenHeader);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        logger.info("processing authentication for '{}'", request.getMethod());
    	logger.info("****************************************************");
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) { 
            ...
            logger.info("User Encrypted Password=[" + userDetails.getPassword() + "]" );
